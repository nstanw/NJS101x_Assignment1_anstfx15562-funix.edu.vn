...
import { Avatar, Button, Card, Descriptions, Form, Input, message, Modal, Switch, UploadFile } from "antd";
      ...
      {nhanVien && (
        <>
          ...
          <Descriptions title="User Info">
            <Descriptions.Item label="Id">{nhanVien?.username}</Descriptions.Item>
            <Descriptions.Item label="Họ và tên">{nhanVien?.name}</Descriptions.Item>
